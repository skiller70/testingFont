...
export default function Education() {
  ...
  const renderNextButton = () => {
    return (
      ...
      >
        <ChevronRightIcon className={`w-16 h-16 ${styles.button}`} />
      </button>
    );
  };
  ...
  const renderPrevButton = () => {
    return (
      ...
      >
        <ChevronLeftIcon className={`w-16 h-16 ${styles.button}`} />
      </button>
    );
  };
  ...
  return (
    ...
    <motion.div
      ...
      ref={animation1}
    >
      <Section dataPosition="education">
        <HeadingDivider
          background
          ...
          <Container>
            ...
            >
              <div className="flex justify-between items-center">
                {renderPrevButton()}
                <div className={styles.pagination} data-id={id} />
                {renderNextButton()}
              </div>
