...
export default function Projects() {
  ...
  return (
    ...
    <motion.div
      ...
      ref={animation1}
    >
      <Section dataPosition="projects" sectionClassName={styles.wrapper}>
        <HeadingDivider
          background
        ...
        <InnerSection>
          ...
          >
            <Container>
              <p className={`text-center ${styles.subheading}`}>
                All projects have been created by myself for educational
                purposes.
              </p>
